...
def mostra_pontos(pnts):
    ...
    pontos = fonte1.render(str(pnts), 1, (255,100,100))
    screen.blit(contador, (460,1))
    screen.blit(pontos,(525,2))     

def conta_lvl(lvl,pnts):
    if lvl == 1 and pnts >= 500:
        lvl += 1
...
def mostra_lvl(lvl):
    ...
    level = font1.render("Fase: ", 1, (255,255,255))
    nlevel = font1.render(str(lvl),1 ,(255,255,255))
    screen.blit(level, (280,1))
    screen.blit(nlevel, (330,1))

def dificulade(speed, lvl):
    if lvl == 2 and speed == 2:
        speed += 62
        return speed
    if lvl == 3 and speed == 4:
        speed +=2
        return speed
